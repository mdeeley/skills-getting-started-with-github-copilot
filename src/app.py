...
activities = {
    "Soccer Team": {
        "description": "Join our varsity soccer team and compete in inter-school matches",
...
def unregister_from_activity(activity_name: str, email: str):
    ...
    if email not in activity["participants"]:
        raise HTTPException(status_code=404, detail="Email not found in this activity")
